...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly",
                                    values=('BFS', 'DFS (Graph Search)', 'DFS (Backtracking)', 'Voraz (Manhattan)', 'ID', 'A* Manhattan', 'A* Euclidean', 'IDA* Manhattan', 'Descolocadas' , 'Secuencias', 'Min'))
    ...
    def readyToSolve():
        ...
        :return: boolean
        """
        return initialState is not None and algorithm is not None and main.isSolvable(initialState)
    ...
    def solveState():
        ...
        if str(algorithm) == 'BFS':
            main.graphSearch(initialState,main.function_1,main.function_0)
            ...
            main.graphSearch(initialState,main.function_1,main.getEuclideanDistance)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'Voraz (Manhattan)':
            main.graphSearch(initialState,main.function_0,main.getManhattanDistance)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'DFS (Graph Search)':
            main.graphSearch(initialState,main.function_N,main.function_0,cutDepth)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'DFS (Backtracking)':
            main.DFS_B(initialState,cutDepth)
            ...
            main.ID_B(initialState)
            path, cost, counter, depth, runtime, nodes, max_stored = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_node_stored
        elif str(algorithm) == 'IDA* Manhattan':
            main.IDA_B(initialState,main.getManhattanDistance)
            path, cost, counter, depth, runtime, nodes, max_stored = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_node_stored
        elif str(algorithm) == 'Descolocadas': 
            main.graphSearch(initialState, main.function_1,main.getDescolocadas)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
            ...
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'Min': 
            main.graphSearch(initialState, main.function_1,main.getMin)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
